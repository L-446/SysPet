...
public class AdocoesDao {
    ...
    public Adocoes buscarAdocoes(int id_adocao) {
        try {

            String sql = "SELECT * FROM tbl_adocao WHERE tbl_adocao.id_adocao = " + id_adocao;
    ...
    public void alterar(Adocoes a) throws Exception {
        try {
            String alteraAdocoes = "UPDATE tbl_adocao SET  nome_do_cliente=?, pk_id_cliente=?, raca=?, pk_id_pet=? WHERE id_adocao='" + a.getId_adocao() + "'";
